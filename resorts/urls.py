...
urlpatterns = [
    ...
    path('admin-resorts/<int:resort_id>/', views.AdminResortView.as_view(), name='resorts.get'),
    path('admin-resorts/<int:resort_id>/images/', views.AdminResortImageView.as_view(), name='resort_images'),
    path('delete-image/', views.delete_image, name='cloudinary-delete'),
    path('admin-resorts-categories/', views.CategoryView.as_view(), name='category-list'),  
    path('admin-resorts-categories/<int:pk>/', views.CategoryView.as_view(), name='category-detail'),  
