...
from .serializers import ResortSerializer, ResortImageSerializer,UserResortSerializer,CategorySerializer,BookedResortSerializer
...
class BookedResortView(APIView):
    ...
    def post(self, request):
        ...
        total_amount = ((package.adult_price * data.get('adults', 0)) + \
                       (package.child_price * data.get('children', 0))*data.get('days'))
