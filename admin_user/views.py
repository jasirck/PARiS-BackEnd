    ...
    def get(self, request):
        try:
            ...
            total_package_revenue = (
                BookedPackage.objects.aggregate(total_revenue=Sum("paid_amount"))[
                    "total_revenue"
                ]
                or 0
            )
            ...
            total_resort_revenue = (
                BookedResort.objects.aggregate(total_revenue=Sum("paid_amount"))[
                    "total_revenue"
                ]
                or 0
            )
            ...
            data = {
                ...
                "most_popular_package": {
                    "name": (
                        most_popular_package["package__name"]
                        if most_popular_package
                        else None
                    ),
                    "bookings": (
                        most_popular_package["num_bookings"]
                        if most_popular_package
                        else 0
                    ),
                },
                "most_popular_resort": {
                    "name": (
                        most_popular_resort["resort__name"]
                        if most_popular_resort
                        else None
                    ),
                    "bookings": (
                        most_popular_resort["num_bookings"]
                        if most_popular_resort
                        else 0
                    ),
                },
