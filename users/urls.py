...
urlpatterns = [
    ...
    path('user/forgot-number-verify', views.SendOtpForgotView.as_view(), name='send-otp'),
    ...
    path('user/reset-password/', views.PasswordResetView.as_view(), name='reset-password'),
]
