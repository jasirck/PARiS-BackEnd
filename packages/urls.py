...
urlpatterns = [
    ...
    path(
        "admin/admin-packages/<int:pk>/",
        views.AdminPackageView.as_view(),
        name="package-detail",
    ),
    path(
        "packages-deteils/<int:pk>/",
        views.PackageDetailsView.as_view(),
        name="package-details",
    ),
    path(
        "admin-packages-request/",
        views.BookedPackageView.as_view(),
    ...
    path(
        "admin/admin-holidays/<int:pk>/",
        views.AdminHolidayView.as_view(),
        name="holiday-detail",
    ),
    path(
        "holidays-deteils/<int:pk>/",
        views.HolidayDetailsView.as_view(),
        name="holiday-details",
    ),
    path("booked-holidays/", views.BookedHolidayView.as_view(), name="package-request"),
    path(
        "admin-booked-holidays/", views.AdminBookedHolidayView.as_view(), name="package"
    ),
    path(
        "admin-package-categories/", views.CategoryView.as_view(), name="category-list"
    ),
    path(
        "admin-package-categories/<int:pk>/",
    ...
    path(
        "admin-booked-package/", views.AdminBookedpackageView.as_view(), name="package"
    ),
