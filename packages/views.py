...
class AdminBookedpackageView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            booking.save()
            return Response({"message": "Holiday request approved successfully"}, status=status.HTTP_200_OK)
...
class AdminHolidayView(APIView):
    ...
    def post(self, request):
        ...
        # If package_serializer is not valid, print its errors
        print("holiday_data:",holiday_data,'holiday_serializer:',holiday_serializer.errors)
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if session.payment_status == "paid":
                ...
                return JsonResponse({"booking_id": booked_package.id,'amount': amount,'name':name }, status=200)
